...
namespace utf8
{
...
#ifdef	ANDROID
		virtual const char* what() { return "Invalid code point"; }
#else
...
#ifdef	ANDROID
		virtual const char* what() { return "Invalid UTF-8"; }
#else
...
#ifdef	ANDROID
		virtual const char* what() { return "Invalid UTF-16"; }
#else
    ...
    public:
#ifdef	ANDROID
		virtual const char* what() { return "Not enough space"; }
#else
